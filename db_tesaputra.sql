...
--
-- Host: localhost
-- Generation Time: Apr 10, 2016 at 02:36 
...
--
ALTER TABLE `tender`
  MODIFY `id_tender` int(3) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `bidang_perusahaan`
  ADD CONSTRAINT `bidang_perusahaan_ibfk_1` FOREIGN KEY (`id_perusahaan`) REFERENCES `perusahaan` (`id_perusahaan`);

--
-- Constraints for table `bidang_tenaga_ahli`
--
ALTER TABLE `bidang_tenaga_ahli`
  ADD CONSTRAINT `bidang_tenaga_ahli_ibfk_1` FOREIGN KEY (`id_ktp`) REFERENCES `tenaga_ahli` (`id_ktp`);

--
-- Constraints for table `bidang_tender`
--
ALTER TABLE `bidang_tender`
  ADD CONSTRAINT `bidang_tender_ibfk_1` FOREIGN KEY (`id_tender`) REFERENCES `tender` (`id_tender`);
